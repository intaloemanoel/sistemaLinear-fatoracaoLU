...
compile-paralelismo: trabalhopratico.c matriz.o vetor-paralelismo.o fatoracaoLU-paralelismo.o
...
vetor-paralelismo.o: vetor.c
	gcc -c -o vetor.o vetor.c -fopenmp

fatoracaoLU-paralelismo.o: fatoracaoLU.c
	gcc -c -o fatoracaoLU.o fatoracaoLU.c -fopenmp
